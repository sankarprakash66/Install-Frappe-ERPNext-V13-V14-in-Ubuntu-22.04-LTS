# Install-Frappe-ERPNext-V13-V14-in-Ubuntu-22.04-LTS
...
### STEP 15 install ERPNext latest version 13 or 14 in bench & site
...
### Step 16 setup production
    ...
    sudo bench setup production local-frappe
    bench restart
...
#### if js and css file is not loading on login window run the following command
    ...
    sudo chmod o+x /home/local-frappe
    
### Step 16 setup Developer Mode
    
    bench set-config developer_mode 1

    ##OR

    ##manually, write '/sites/{your site}/site_config.json'
